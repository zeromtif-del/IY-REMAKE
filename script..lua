...
--==============================================================
--  INFINITE YIELD FE  ·  MODERN UI REDESIGN
--  Замена секции построения GUI (см. инструкцию ниже)
--  Все переменные сохранены для совместимости с оригиналом
--==============================================================
...
--╚══════════════════════════════════════════════════════════╝
Theme = {
    Bg0      = Color3.fromRGB(13, 15, 22),     -- окно
    Bg1      = Color3.fromRGB(20, 23, 33),     -- панели
    Bg2      = Color3.fromRGB(28, 32, 45),     -- кнопки
    Bg3      = Color3.fromRGB(38, 43, 60),     -- hover / активное
    Border   = Color3.fromRGB(48, 54, 76),
    Accent   = Color3.fromRGB(124, 58, 237),   -- фиолетовый
    Accent2  = Color3.fromRGB(167, 139, 250),
    Accent3  = Color3.fromRGB(88, 42, 173),
...
-- обновляем старые переменные палитры, чтобы плагины и команды
-- (restorelighting, updateColors, etc.) работали корректно
currentShade1 = Theme.Bg1
currentShade2 = Theme.Bg2
currentShade3 = Theme.Accent3
currentText1  = Theme.Text
currentText2  = Theme.Bg0
currentScroll = Theme.Accent2
...
local function stroke(obj, col, thickness, trans)
...
local function hpad(obj, amt)
    local p = Instance.new("UIPadding")
    p.PaddingLeft = UDim.new(0, amt)
    p.PaddingRight = UDim.new(0, amt)
    p.Parent = obj
    return p
end

-- современный "стеклянный" стиль кнопки
local function styleButton(btn, accent)
    btn.BackgroundColor3 = accent and Theme.Accent3 or Theme.Bg2
    btn.BorderSizePixel = 0
    btn.AutoButtonColor = false
    corner(btn, 6)
    stroke(btn, accent and Theme.Accent2 or Theme.Border, 1, 0.3)
    btn.TextColor3 = Theme.Text
    btn.Font = Theme.FontMed
    btn.TextSize = 14

    local tween = TweenInfo.new(0.15, Enum.EasingStyle.Quart, Enum.EasingDirection.Out)
    btn.MouseEnter:Connect(function()
        TweenService:Create(btn, tween, {
            BackgroundColor3 = accent and Theme.Accent or Theme.Bg3
        }):Play()
    end)
    btn.MouseLeave:Connect(function()
        TweenService:Create(btn, tween, {
            BackgroundColor3 = accent and Theme.Accent3 or Theme.Bg2
        }):Play()
    end)
    return btn
end
...
-- современный toggle
local function makeToggle(parent, defaultOn, callback)
    local frame = Instance.new("Frame")
    frame.Name = "ToggleFrame"
    frame.Size = UDim2.new(0, 38, 0, 20)
    frame.Position = UDim2.new(1, -42, 0.5, -10)
    frame.BackgroundColor3 = defaultOn and Theme.Accent or Theme.Bg3
    ...
    knob.Position = defaultOn and UDim2.new(1, -18, 0, 2) or UDim2.new(0, 2, 0, 2)
    ...
    local tw = TweenInfo.new(0.2, Enum.EasingStyle.Quart, Enum.EasingDirection.Out)
    ...
    return {
        ...
        Set = function(v, silent)
            state = v
            frame.BackgroundColor3 = state and Theme.Accent or Theme.Bg3
...
Holder.Active = true
Holder.BackgroundColor3 = Theme.Bg0
Holder.BorderSizePixel = 0
Holder.Position = UDim2.new(1, -270, 1, -260)
Holder.Size = UDim2.new(0, 270, 0, 260)
Holder.ZIndex = 10
Holder.ClipsDescendants = true
corner(Holder, 12)
stroke(Holder, Theme.Border, 1, 0.2)
table.insert(shade2, Holder)

-- ── Title bar (gradient + accent) ──────────────────────────
Title.Name = "Title"
Title.Parent = Holder
Title.Active = true
Title.BackgroundColor3 = Theme.Accent3
...
Title.ZIndex = 10
gradient(Title, Theme.Accent, Theme.Accent3, 90)
corner(Title, 12)
do -- срезаем нижние углы скругления
    local fix = Instance.new("Frame")
    fix.Size = UDim2.new(1, 0, 0, 12)
    fix.Position = UDim2.new(0, 0, 1, -12)
    fix.BackgroundColor3 = Theme.Accent3
...
-- сезонные эмодзи (сохранено из оригинала)
do
    local emoji = ({
        ["01 01"] = "🎆",
        ["02 14"] = "💝",
        ...
        [(function(Year)
            ...
            local G = (22+E+F)
            if E == 29 and F == 6 then return "04 19"
            elseif E == 28 and F == 6 then return "04 18"
            elseif 31 < G then return ("04 %02d"):format(G-31) end
...
-- ── Dark panel (основной контейнер контента) ──────────────
Dark.Name = "Dark"
Dark.Parent = Holder
Dark.Active = true
Dark.BackgroundColor3 = Theme.Bg1
Dark.BorderSizePixel = 0
Dark.Position = UDim2.new(0, 0, 0, 55)
Dark.Size = UDim2.new(0, 270, 0, 205)
Dark.ZIndex = 10
...
Cmdbar.BackgroundColor3 = Theme.Bg2
Cmdbar.BorderSizePixel = 0
Cmdbar.Position = UDim2.new(0, 12, 0, 40)
Cmdbar.Size = UDim2.new(0, 246, 0, 30)
Cmdbar.Font = Theme.FontMed
Cmdbar.TextSize = 14
Cmdbar.TextXAlignment = Enum.TextXAlignment.Left
Cmdbar.TextColor3 = Theme.Text
Cmdbar.PlaceholderColor3 = Theme.TextDim
Cmdbar.Text = ""
Cmdbar.ZIndex = 10
Cmdbar.PlaceholderText = "⌘  Command Bar"
corner(Cmdbar, 8)
stroke(Cmdbar, Theme.Border, 1, 0.5)
table.insert(shade2, Cmdbar)
...
CMDsF.Position = UDim2.new(0, 8, 0, 78)
CMDsF.Size = UDim2.new(0, 254, 0, 175)
CMDsF.ScrollBarImageColor3 = Theme.Accent2
...
SettingsButton.Position = UDim2.new(0, 236, 0, 6)
...
ReferenceButton.Position = UDim2.new(0, 212, 0, 6)
ReferenceButton.Size = UDim2.new(0, 20, 0, 20)
ReferenceButton.Image = getcustomasset("infiniteyield/assets/reference.png")
ReferenceButton.ImageColor3 = Color3.fromRGB(255, 255, 255)
...
Settings.BackgroundColor3 = Theme.Bg1
Settings.BorderSizePixel = 0
Settings.Position = UDim2.new(0, 0, 0, 260)
Settings.Size = UDim2.new(0, 270, 0, 205)
Settings.ZIndex = 10
...
SettingsHolder.ScrollBarImageColor3 = Theme.Accent2
SettingsHolder.BottomImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
SettingsHolder.CanvasSize = UDim2.new(0, 0, 0, 240)
SettingsHolder.MidImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
SettingsHolder.ScrollBarThickness = 5
...
Prefix.Position = UDim2.new(0, 12, 0, 8)
Prefix.Size = UDim2.new(1, -24, 0, 24)
Prefix.Font = Theme.FontMed
Prefix.TextSize = 13
Prefix.Text = "Prefix"
...
PrefixBox.BackgroundColor3 = Theme.Bg2
PrefixBox.BorderSizePixel = 0
PrefixBox.Position = UDim2.new(1, -40, 0.5, -11)
PrefixBox.Size = UDim2.new(0, 40, 0, 22)
PrefixBox.Font = Theme.FontBold
PrefixBox.TextSize = 14
PrefixBox.Text = ''
PrefixBox.TextColor3 = Theme.Accent2
PrefixBox.ZIndex = 10
corner(PrefixBox, 6)
stroke(PrefixBox, Theme.Border, 1, 0.4)
table.insert(shade3, PrefixBox)
table.insert(text2, PrefixBox)

-- helper: современная "строка настроек"
local function makeSettingsButton(name, iconID, off)
    ...
    icon.Image = iconID
    icon.ImageColor3 = Theme.Accent2
    icon.ZIndex = 10
    if off then
    ...
    local tw = TweenInfo.new(0.15, Enum.EasingStyle.Quart, Enum.EasingDirection.Out)
    button.MouseEnter:Connect(function()
        TweenService:Create(button, tw, {BackgroundColor3 = Theme.Bg3}):Play()
    end)
    button.MouseLeave:Connect(function()
        TweenService:Create(button, tw, {BackgroundColor3 = Theme.Bg2}):Play()
    end)
    return button
end
...
ColorsButton.Position = UDim2.new(0, 12, 0, 100)
ColorsButton.Size = UDim2.new(1, -24, 0, 36)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Edit Keybinds", getcustomasset("infiniteyield/assets/editkeybinds.png"))
Keybinds.Position = UDim2.new(0, 12, 0, 142)
Keybinds.Size = UDim2.new(1, -24, 0, 36)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Edit Aliases", getcustomasset("infiniteyield/assets/editaliases.png"))
Aliases.Position = UDim2.new(0, 12, 0, 184)
Aliases.Size = UDim2.new(1, -24, 0, 36)
Aliases.Name = "Aliases"
Aliases.Parent = SettingsHolder

Positions = makeSettingsButton("Edit / Goto Waypoints", getcustomasset("infiniteyield/assets/editwaypoints.png"))
Positions.Position = UDim2.new(0, 12, 0, 226)
Positions.Size = UDim2.new(1, -24, 0, 36)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Edit Event Binds", getcustomasset("infiniteyield/assets/bindsandplugins.png"), 759)
EventBind.Position = UDim2.new(0, 12, 0, 310)
EventBind.Size = UDim2.new(1, -24, 0, 36)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Manage Plugins", getcustomasset("infiniteyield/assets/bindsandplugins.png"), 743)
Plugins.Position = UDim2.new(0, 12, 0, 268)
Plugins.Size = UDim2.new(1, -24, 0, 36)
Plugins.Name = "Plugins"
Plugins.Parent = SettingsHolder

-- ── Stay Open (переработано на красивый switch) ────────────
StayOpen.Name = "StayOpen"
StayOpen.Parent = SettingsHolder
StayOpen.BackgroundTransparency = 1
StayOpen.Position = UDim2.new(0, 12, 0, 46)
StayOpen.Size = UDim2.new(1, -24, 0, 26)
StayOpen.Font = Theme.FontMed
StayOpen.TextSize = 13
StayOpen.Text = "Keep Menu Open"
StayOpen.TextColor3 = Theme.Text
StayOpen.TextXAlignment = Enum.TextXAlignment.Left
StayOpen.ZIndex = 10
table.insert(text1, StayOpen)

-- старые Button/On для совместимости (визуально перекрыты switch'ем)
Button = Instance.new("Frame")
Button.Name = "Button"
...
On.Size = UDim2.new(0, 0, 0, 0)
On.Text = ""
On.Parent = Button
-- сам switch:
local stayToggle = makeToggle(StayOpen, false, function(state)
    -- заменит логику через On
...
-- синхронизируем старый On/скрипт ↔ новый switch
On.MouseButton1Click:Connect(function()
    stayToggle.Set(not stayToggle.Get(), true)
end)

-- ── Example (шаблон элемента команд) ───────────────────────
Example.Name = "Example"
Example.Parent = Holder
Example.BackgroundColor3 = Theme.Bg2
Example.BorderSizePixel = 0
Example.Size = UDim2.new(0, 240, 0, 24)
Example.Visible = false
Example.Font = Theme.FontMed
Example.TextSize = 13
Example.Text = "Example"
Example.TextColor3 = Theme.Text
Example.TextXAlignment = Enum.TextXAlignment.Left
Example.ZIndex = 10
corner(Example, 6)
padding(Example, 0, 0, 10, 10)
...
Notification.BackgroundColor3 = Theme.Bg1
Notification.BorderSizePixel = 0
Notification.Position = UDim2.new(1, -520, 1, 20)
Notification.Size = UDim2.new(0, 260, 0, 100)
Notification.ZIndex = 10
corner(Notification, 10)
stroke(Notification, Theme.Accent, 1, 0.3)
table.insert(shade1, Notification)

Title_2.Name = "Title"
Title_2.Parent = Notification
Title_2.BackgroundColor3 = Theme.Accent3
Title_2.BorderSizePixel = 0
Title_2.Size = UDim2.new(0, 260, 0, 26)
Title_2.Font = Theme.FontBold
Title_2.TextSize = 13
...
Title_2.ZIndex = 10
corner(Title_2, 10)
gradient(Title_2, Theme.Accent, Theme.Accent3, 90)
...
Text_2.Position = UDim2.new(0, 10, 0, 32)
Text_2.Size = UDim2.new(0, 240, 0, 62)
Text_2.Font = Theme.FontMed
Text_2.TextSize = 13
Text_2.Text = "Notification Text"
Text_2.TextColor3 = Theme.TextDim
...
CloseImage.ZIndex = 12

PinButton.Name = "PinButton"
PinButton.Parent = Notification
PinButton.BackgroundTransparency = 1
PinButton.Position = UDim2.new(0, 2, 0, 2)
...
Tooltip.Active = true
Tooltip.BackgroundColor3 = Theme.Bg1
...
Tooltip.ZIndex = 10
corner(Tooltip, 8)
stroke(Tooltip, Theme.Accent, 1, 0.4)
table.insert(shade1, Tooltip)

Title_3.Name = "Title"
Title_3.Parent = Tooltip
Title_3.BackgroundColor3 = Theme.Accent3
Title_3.BackgroundTransparency = 0.1
Title_3.BorderSizePixel = 0
Title_3.Size = UDim2.new(0, 220, 0, 24)
Title_3.Font = Theme.FontBold
Title_3.TextSize = 13
Title_3.Text = ""
...
Description.Size = UDim2.new(0, 200, 0, 66)
Description.Font = Theme.FontMed
...
IntroBackground.BackgroundColor3 = Theme.Bg1
IntroBackground.BorderSizePixel = 0
IntroBackground.Position = UDim2.new(0, 0, 0, 55)
IntroBackground.Size = UDim2.new(0, 270, 0, 205)
...
Logo.Position = UDim2.new(0, 135, 0, 157)
...
Credits.Size = UDim2.new(0, 270, 0, 20)
Credits.Font = Enum.Font.GothamLight
Credits.TextSize = 12
...
KeybindsFrame.BackgroundColor3 = Theme.Bg1
KeybindsFrame.BorderSizePixel = 0
KeybindsFrame.Position = UDim2.new(0, 0, 0, 205)
KeybindsFrame.Size = UDim2.new(0, 270, 0, 205)
KeybindsFrame.ZIndex = 10
corner(KeybindsFrame, 0)
table.insert(shade1, KeybindsFrame)

Close = Instance.new("TextButton")
Close.Name = "Close"
Close.Parent = KeybindsFrame
Close.Position = UDim2.new(0, 218, 0, 172)
Close.Size = UDim2.new(0, 44, 0, 26)
Close.Text = "Close"
styleButton(Close)
...
Add.Position = UDim2.new(0, 8, 0, 172)
Add.Size = UDim2.new(0, 44, 0, 26)
Add.Text = "Add"
...
Delete.Position = UDim2.new(0, 58, 0, 172)
Delete.Size = UDim2.new(0, 56, 0, 26)
Delete.Text = "Clear"
styleButton(Delete)
...
Holder_2.Position = UDim2.new(0, 8, 0, 8)
Holder_2.Size = UDim2.new(0, 254, 0, 160)
Holder_2.ScrollBarImageColor3 = Theme.Accent2
Holder_2.BottomImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
Holder_2.CanvasSize = UDim2.new(0, 0, 0, 0)
Holder_2.MidImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
Holder_2.ScrollBarThickness = 4
...
Example_2.BackgroundColor3 = Theme.Bg2
Example_2.BorderSizePixel = 0
Example_2.Size = UDim2.new(0, 10, 0, 24)
...
Text_3.Size = UDim2.new(0, 240, 0, 24)
Text_3.Font = Theme.FontMed
Text_3.TextSize = 13
Text_3.Text = "nom"
Text_3.TextColor3 = Theme.Text
...
Delete_2.Position = UDim2.new(0, 200, 0, 2)
Delete_2.Size = UDim2.new(0, 44, 0, 20)
Delete_2.Text = "Delete"
styleButton(Delete_2, true)
...
KeybindEditor.Position = UDim2.new(0.5, -190, 0, -500)
KeybindEditor.Size = UDim2.new(0, 380, 0, 20)
...
background_2.BackgroundColor3 = Theme.Bg1
background_2.BorderSizePixel = 0
background_2.Position = UDim2.new(0, 0, 0, 24)
background_2.Size = UDim2.new(0, 380, 0, 200)
background_2.ZIndex = 10
corner(background_2, 10)
stroke(background_2, Theme.Border, 1, 0.4)
...
Dark_3.Active = true
Dark_3.BackgroundColor3 = Theme.Border
Dark_3.BorderSizePixel = 0
Dark_3.Position = UDim2.new(0, 145, 0, 8)
Dark_3.Size = UDim2.new(0, 1, 0, 184)
Dark_3.ZIndex = 10
...
Directions.Position = UDim2.new(0, 12, 0, 16)
Directions.Size = UDim2.new(0, 122, 0, 90)
Directions.ZIndex = 10
Directions.Font = Theme.FontMed
Directions.Text = "Click the button below and press a key/mouse button. Then select what you want to bind it to."
Directions.TextColor3 = Theme.TextDim
Directions.TextSize = 12
...
BindTo.Position = UDim2.new(0, 12, 0, 100)
BindTo.Size = UDim2.new(0, 122, 0, 44)
BindTo.Text = "Click to bind"
styleButton(BindTo, true)
BindTo.TextSize = 14
...
TriggerLabel.Position = UDim2.new(0, 12, 0, 156)
TriggerLabel.Size = UDim2.new(0, 60, 0, 20)
TriggerLabel.ZIndex = 10
TriggerLabel.Font = Theme.FontMed
TriggerLabel.Text = "Trigger:"
TriggerLabel.TextColor3 = Theme.TextDim
...
BindTriggerSelect.Position = UDim2.new(0, 74, 0, 154)
BindTriggerSelect.Size = UDim2.new(0, 60, 0, 22)
BindTriggerSelect.Text = "KeyDown"
styleButton(BindTriggerSelect)
BindTriggerSelect.TextSize = 12
...
Add_2.Position = UDim2.new(0, 320, 0, 40)
Add_2.Size = UDim2.new(0, 48, 0, 24)
Add_2.Text = "Add"
styleButton(Add_2, true)
...
Toggles.Position = UDim2.new(0, 156, 0, 128)
Toggles.Size = UDim2.new(0, 212, 0, 56)
Toggles.ZIndex = 10
Toggles.BottomImage = "rbxasset://textures/ui/Scroll/scroll-middle.png"
Toggles.CanvasSize = UDim2.new(0, 0, 0, 56)
Toggles.ScrollBarThickness = 4
...
ClickTP.Size = UDim2.new(0, 212, 0, 24)
ClickTP.ZIndex = 10
ClickTP.Font = Theme.FontMed
ClickTP.Text = "    Click TP (Hold Key & Click)"
ClickTP.TextColor3 = Theme.Text
ClickTP.TextSize = 12
...
Select.Position = UDim2.new(0, 160, 0, 1)
Select.Size = UDim2.new(0, 48, 0, 22)
Select.Text = "Add"
styleButton(Select, true)
...
ClickDelete.BackgroundTransparency = 1
ClickDelete.Position = UDim2.new(0, 0, 0, 28)
ClickDelete.Size = UDim2.new(0, 212, 0, 24)
ClickDelete.ZIndex = 10
ClickDelete.Font = Theme.FontMed
ClickDelete.Text = "    Click Delete (Hold Key & Click)"
ClickDelete.TextColor3 = Theme.Text
ClickDelete.TextSize = 12
...
Select_2.Position = UDim2.new(0, 160, 0, 1)
Select_2.Size = UDim2.new(0, 48, 0, 22)
Select_2.Text = "Add"
styleButton(Select_2, true)
...
Cmdbar_2.BackgroundColor3 = Theme.Bg2
Cmdbar_2.BorderSizePixel = 0
Cmdbar_2.Position = UDim2.new(0, 156, 0, 40)
Cmdbar_2.Size = UDim2.new(0, 156, 0, 24)
Cmdbar_2.ZIndex = 10
Cmdbar_2.Font = Theme.FontMed
Cmdbar_2.PlaceholderText = "Command"
Cmdbar_2.PlaceholderColor3 = Theme.TextDim
Cmdbar_2.Text = ""
Cmdbar_2.TextColor3 = Theme.Text
Cmdbar_2.TextSize = 12
Cmdbar_2.TextXAlignment = Enum.TextXAlignment.Left
corner(Cmdbar_2, 6)
stroke(Cmdbar_2, Theme.Border, 1, 0.4)
padding(Cmdbar_2, 0, 0, 8, 8)

Cmdbar_3 = Instance.new("TextBox")
Cmdbar_3.Name = "Cmdbar_3"
Cmdbar_3.Parent = background_2
Cmdbar_3.BackgroundColor3 = Theme.Bg2
Cmdbar_3.BorderSizePixel = 0
Cmdbar_3.Position = UDim2.new(0, 156, 0, 70)
Cmdbar_3.Size = UDim2.new(0, 156, 0, 24)
Cmdbar_3.ZIndex = 10
Cmdbar_3.Font = Theme.FontMed
Cmdbar_3.PlaceholderText = "Command 2"
Cmdbar_3.PlaceholderColor3 = Theme.TextDim
Cmdbar_3.Text = ""
Cmdbar_3.TextColor3 = Theme.Text
Cmdbar_3.TextSize = 12
Cmdbar_3.TextXAlignment = Enum.TextXAlignment.Left
corner(Cmdbar_3, 6)
stroke(Cmdbar_3, Theme.Border, 1, 0.4)
padding(Cmdbar_3, 0, 0, 8, 8)
...
CreateToggle.Position = UDim2.new(0, 158, 0, 10)
CreateToggle.Size = UDim2.new(0, 208, 0, 24)
CreateToggle.ZIndex = 10
CreateToggle.Font = Theme.FontMed
CreateToggle.Text = "Create Toggle"
CreateToggle.TextColor3 = Theme.Text
CreateToggle.TextSize = 12
CreateToggle.TextXAlignment = Enum.TextXAlignment.Left
table.insert(text1, CreateToggle)

-- используем современный тумблер, совместимый со старым On_2
Button_2 = Instance.new("Frame")
Button_2.Name = "Button"
Button_2.BackgroundTransparency = 1
Button_2.Size = UDim2.new(0, 0, 0, 0)
Button_2.Parent = CreateToggle

On_2 = Instance.new("TextButton")
On_2.Name = "On"
On_2.BackgroundTransparency = 1
On_2.Size = UDim2.new(0, 0, 0, 0)
On_2.Text = ""
On_2.Parent = Button_2
local toggleBtn = makeToggle(CreateToggle, false, nil)
On_2.MouseButton1Click:Connect(function()
    toggleBtn.Set(not toggleBtn.Get(), true)
end)

shadow_2 = Instance.new("Frame")
shadow_2.Name = "shadow"
shadow_2.Parent = KeybindEditor
shadow_2.BackgroundColor3 = Theme.Bg2
shadow_2.BorderSizePixel = 0
shadow_2.Size = UDim2.new(0, 380, 0, 24)
shadow_2.ZIndex = 10
corner(shadow_2, 10)
gradient(shadow_2, Theme.Bg2, Theme.Bg1, 90)
...
PopupText_2.Size = UDim2.new(1, 0, 1, 0)
PopupText_2.ZIndex = 10
PopupText_2.Font = Theme.FontBold
PopupText_2.Text = "Set Keybinds"
PopupText_2.TextColor3 = Theme.Text
PopupText_2.TextSize = 13
PopupText_2.TextXAlignment = Enum.TextXAlignment.Left
padding(PopupText_2, 0, 0, 12, 0)
...
Exit_2.Position = UDim2.new(1, -22, 0, 2)
...
PositionsFrame.BackgroundColor3 = Theme.Bg1
PositionsFrame.BorderSizePixel = 0
PositionsFrame.Size = UDim2.new(0, 270, 0, 205)
PositionsFrame.Position = UDim2.new(0, 0, 0, 205)
...
Close_3.Position = UDim2.new(0, 218, 0, 172)
Close_3.Size = UDim2.new(0, 44, 0, 26)
Close_3.Text = "Close"
styleButton(Close_3)
...
Delete_5.Position = UDim2.new(0, 58, 0, 172)
Delete_5.Size = UDim2.new(0, 56, 0, 26)
Delete_5.Text = "Clear"
styleButton(Delete_5)
...
Part.Position = UDim2.new(0, 8, 0, 172)
Part.Size = UDim2.new(0, 44, 0, 26)
Part.Text = "Part"
styleButton(Part, true)
...
Holder_4.Position = UDim2.new(0, 8, 0, 8)
Holder_4.Size = UDim2.new(0, 254, 0, 160)
Holder_4.ScrollBarImageColor3 = Theme.Accent2
...
Example_4.BackgroundColor3 = Theme.Bg2
Example_4.BorderSizePixel = 0
Example_4.Size = UDim2.new(0, 10, 0, 24)
...
Text_5.Size = UDim2.new(0, 240, 0, 24)
Text_5.Font = Theme.FontMed
Text_5.TextSize = 13
Text_5.Text = "Position"
Text_5.TextColor3 = Theme.Text
...
Delete_6.Position = UDim2.new(0, 200, 0, 2)
Delete_6.Size = UDim2.new(0, 44, 0, 20)
Delete_6.Text = "Delete"
styleButton(Delete_6, true)
...
TP.Name = "TP"
TP.Parent = Text_5
TP.Position = UDim2.new(0, 152, 0, 2)
...
AliasesFrame.BackgroundColor3 = Theme.Bg1
AliasesFrame.BorderSizePixel = 0
AliasesFrame.Position = UDim2.new(0, 0, 0, 205)
AliasesFrame.Size = UDim2.new(0, 270, 0, 205)
...
Close_2.Position = UDim2.new(0, 218, 0, 172)
Close_2.Size = UDim2.new(0, 44, 0, 26)
Close_2.Text = "Close"
styleButton(Close_2)
...
Delete_3.Position = UDim2.new(0, 8, 0, 172)
Delete_3.Size = UDim2.new(0, 56, 0, 26)
Delete_3.Text = "Clear"
styleButton(Delete_3)
...
Holder_3.Position = UDim2.new(0, 8, 0, 8)
Holder_3.Size = UDim2.new(0, 254, 0, 160)
Holder_3.ScrollBarImageColor3 = Theme.Accent2
...
Example_3.BackgroundColor3 = Theme.Bg2
Example_3.BorderSizePixel = 0
Example_3.Size = UDim2.new(0, 10, 0, 24)
...
Text_4.Size = UDim2.new(0, 240, 0, 24)
Text_4.Font = Theme.FontMed
Text_4.TextSize = 13
Text_4.Text = "honk"
Text_4.TextColor3 = Theme.Text
...
Delete_4.Position = UDim2.new(0, 200, 0, 2)
Delete_4.Size = UDim2.new(0, 44, 0, 20)
Delete_4.Text = "Delete"
styleButton(Delete_4, true)
...
PluginsFrame.BackgroundColor3 = Theme.Bg1
PluginsFrame.BorderSizePixel = 0
PluginsFrame.Position = UDim2.new(0, 0, 0, 205)
PluginsFrame.Size = UDim2.new(0, 270, 0, 205)
...
Close_4.Position = UDim2.new(0, 218, 0, 172)
Close_4.Size = UDim2.new(0, 44, 0, 26)
Close_4.Text = "Close"
styleButton(Close_4)
...
Add_3.Position = UDim2.new(0, 8, 0, 172)
Add_3.Size = UDim2.new(0, 44, 0, 26)
Add_3.Text = "Add"
styleButton(Add_3, true)
...
Holder_5.Position = UDim2.new(0, 8, 0, 8)
Holder_5.Size = UDim2.new(0, 254, 0, 160)
Holder_5.ScrollBarImageColor3 = Theme.Accent2
...
Example_5.BackgroundColor3 = Theme.Bg2
Example_5.BorderSizePixel = 0
Example_5.Size = UDim2.new(0, 10, 0, 24)
...
Text_6.Size = UDim2.new(0, 240, 0, 24)
Text_6.Font = Theme.FontMed
Text_6.TextSize = 13
Text_6.Text = "F4 > Toggle Fly"
Text_6.TextColor3 = Theme.Text
...
Delete_7.Position = UDim2.new(0, 200, 0, 2)
Delete_7.Size = UDim2.new(0, 44, 0, 20)
Delete_7.Text = "Delete"
styleButton(Delete_7, true)
...
PluginEditor.Position = UDim2.new(0.5, -190, 0, -500)
PluginEditor.Size = UDim2.new(0, 380, 0, 20)
...
background_3.BackgroundColor3 = Theme.Bg1
background_3.BorderSizePixel = 0
background_3.Position = UDim2.new(0, 0, 0, 24)
background_3.Size = UDim2.new(0, 380, 0, 175)
background_3.ZIndex = 10
corner(background_3, 10)
stroke(background_3, Theme.Border, 1, 0.4)
...
Dark_2.Active = true
Dark_2.BackgroundColor3 = Theme.Border
Dark_2.BorderSizePixel = 0
Dark_2.Position = UDim2.new(0, 232, 0, 8)
Dark_2.Size = UDim2.new(0, 1, 0, 160)
Dark_2.ZIndex = 10
...
Img.Position = UDim2.new(0, 252, 0, 8)
...
AddPlugin.Position = UDim2.new(0, 245, 0, 110)
AddPlugin.Size = UDim2.new(0, 122, 0, 50)
AddPlugin.Text = "Add Plugin"
styleButton(AddPlugin, true)
...
FileName.BackgroundColor3 = Theme.Bg2
FileName.BorderSizePixel = 0
FileName.Position = UDim2.new(0, 15, 0, 110)
FileName.Size = UDim2.new(0, 210, 0, 44)
FileName.Font = Theme.FontMed
FileName.TextSize = 13
FileName.Text = "Plugin File Name"
FileName.TextColor3 = Theme.TextDim
FileName.ZIndex = 10
corner(FileName, 8)
stroke(FileName, Theme.Border, 1, 0.4)
padding(FileName, 0, 0, 10, 10)
...
About.Position = UDim2.new(0, 15, 0, 15)
About.Size = UDim2.new(0, 205, 0, 50)
About.Font = Theme.FontMed
About.TextSize = 12
About.Text = "Plugins are .iy files and should be located in the 'workspace' folder of your exploit."
About.TextColor3 = Theme.TextDim
...
Directions_2.Position = UDim2.new(0, 15, 0, 68)
Directions_2.Size = UDim2.new(0, 205, 0, 40)
Directions_2.Font = Theme.FontMed
Directions_2.TextSize = 12
Directions_2.Text = "Type the name of the plugin file you want to add below."
Directions_2.TextColor3 = Theme.TextDim
Directions_2.TextWrapped = true
Directions_2.TextXAlignment = Enum.TextXAlignment.Left
...
shadow_3.BackgroundColor3 = Theme.Bg2
shadow_3.BorderSizePixel = 0
shadow_3.Size = UDim2.new(0, 380, 0, 24)
shadow_3.ZIndex = 10
corner(shadow_3, 10)
gradient(shadow_3, Theme.Bg2, Theme.Bg1, 90)
...
PopupText_3.Size = UDim2.new(1, 0, 1, 0)
PopupText_3.ZIndex = 10
PopupText_3.Font = Theme.FontBold
PopupText_3.TextSize = 13
PopupText_3.Text = "Add Plugins"
PopupText_3.TextColor3 = Theme.Text
PopupText_3.TextXAlignment = Enum.TextXAlignment.Left
padding(PopupText_3, 0, 0, 12, 0)
...
Exit_3.Position = UDim2.new(1, -22, 0, 2)
...
AliasHint.Position = UDim2.new(0, 25, 0, 60)
AliasHint.Size = UDim2.new(0, 220, 0, 50)
AliasHint.Font = Enum.Font.GothamMedium
AliasHint.TextSize = 13
AliasHint.Text = "Add aliases by using the 'addalias' command"
AliasHint.TextColor3 = Theme.TextDim
...
PluginsHint.Position = UDim2.new(0, 25, 0, 60)
PluginsHint.Size = UDim2.new(0, 220, 0, 50)
PluginsHint.Font = Enum.Font.GothamMedium
PluginsHint.TextSize = 13
PluginsHint.Text = "Download plugins from the IY Discord (discord.gg/78ZuWSq)"
PluginsHint.TextColor3 = Theme.TextDim
...
PositionsHint.Position = UDim2.new(0, 20, 0, 55)
PositionsHint.Size = UDim2.new(0, 230, 0, 70)
PositionsHint.Font = Enum.Font.GothamMedium
PositionsHint.TextSize = 13
...
PositionsHint.TextColor3 = Theme.TextDim
...
ToPartFrame.Position = UDim2.new(0.5, -190, 0, -500)
ToPartFrame.Size = UDim2.new(0, 380, 0, 20)
...
background_4.BackgroundColor3 = Theme.Bg1
background_4.BorderSizePixel = 0
background_4.Position = UDim2.new(0, 0, 0, 24)
background_4.Size = UDim2.new(0, 380, 0, 130)
background_4.ZIndex = 10
corner(background_4, 10)
stroke(background_4, Theme.Border, 1, 0.4)
table.insert(shade1, background_4)

ChoosePart = Instance.new("TextButton")
ChoosePart.Name = "ChoosePart"
ChoosePart.Parent = background_4
ChoosePart.Position = UDim2.new(0, 105, 0, 62)
ChoosePart.Size = UDim2.new(0, 80, 0, 32)
ChoosePart.Text = "Select Part"
styleButton(ChoosePart, true)
...
CopyPath.Position = UDim2.new(0, 195, 0, 62)
CopyPath.Size = UDim2.new(0, 80, 0, 32)
CopyPath.Text = "Copy Path"
styleButton(CopyPath)
...
Directions_3.Position = UDim2.new(0, 20, 0, 16)
Directions_3.Size = UDim2.new(0, 340, 0, 40)
Directions_3.Font = Theme.FontMed
Directions_3.TextSize = 12
Directions_3.Text = 'Click on a part and then click the "Select Part" button below to set it as a teleport location'
Directions_3.TextColor3 = Theme.TextDim
Directions_3.TextWrapped = true
Directions_3.TextXAlignment = Enum.TextXAlignment.Center
...
Path.Position = UDim2.new(0, 0, 0, 105)
Path.Size = UDim2.new(0, 380, 0, 16)
Path.Font = Enum.Font.GothamMedium
Path.TextSize = 12
Path.Text = ""
Path.TextColor3 = Theme.Accent2
...
shadow_4.BackgroundColor3 = Theme.Bg2
shadow_4.BorderSizePixel = 0
shadow_4.Size = UDim2.new(0, 380, 0, 24)
shadow_4.ZIndex = 10
corner(shadow_4, 10)
gradient(shadow_4, Theme.Bg2, Theme.Bg1, 90)
...
PopupText_5.Size = UDim2.new(1, 0, 1, 0)
PopupText_5.ZIndex = 10
PopupText_5.Font = Theme.FontBold
PopupText_5.TextSize = 13
PopupText_5.Text = "Teleport to Part"
PopupText_5.TextColor3 = Theme.Text
PopupText_5.TextXAlignment = Enum.TextXAlignment.Left
padding(PopupText_5, 0, 0, 12, 0)
...
Exit_4.Position = UDim2.new(1, -22, 0, 2)
...
logs.Size = UDim2.new(0, 360, 0, 20)
logs.ZIndex = 10

shadow = Instance.new("Frame")
shadow.Name = "shadow"
shadow.Parent = logs
shadow.BackgroundColor3 = Theme.Bg2
shadow.BorderSizePixel = 0
shadow.Position = UDim2.new(0, 0, 0.00999999978, 0)
shadow.Size = UDim2.new(0, 360, 0, 24)
shadow.ZIndex = 10
corner(shadow, 8)
gradient(shadow, Theme.Bg2, Theme.Bg1, 90)
...
Hide.Position = UDim2.new(1, -56, 0, 2)
...
background.BackgroundColor3 = Theme.Bg0
background.BorderSizePixel = 0
background.ClipsDescendants = true
background.Position = UDim2.new(0, 0, 1, 0)
background.Size = UDim2.new(0, 360, 0, 260)
...
chat.Active = true
chat.BackgroundColor3 = Theme.Bg0
chat.BorderSizePixel = 0
chat.ClipsDescendants = true
chat.Size = UDim2.new(0, 360, 0, 260)
chat.ZIndex = 10
...
Clear.Name = "Clear"
Clear.Parent = chat
Clear.Position = UDim2.new(0, 10, 0, 228)
...
SaveChatlogs.Position = UDim2.new(0, 270, 0, 228)
SaveChatlogs.Size = UDim2.new(0, 80, 0, 24)
SaveChatlogs.Text = "Save .txt"
styleButton(SaveChatlogs, true)
...
Toggle.Name = "Toggle"
Toggle.Parent = chat
Toggle.Position = UDim2.new(0, 76, 0, 228)
...
scroll_2.BackgroundColor3 = Theme.Bg1
scroll_2.BorderSizePixel = 0
scroll_2.Position = UDim2.new(0, 10, 0, 34)
scroll_2.Size = UDim2.new(0, 340, 0, 186)
scroll_2.ZIndex = 10
...
scroll_2.ScrollBarImageColor3 = Theme.Accent2
...
join.Active = true
join.BackgroundColor3 = Theme.Bg0
join.BorderSizePixel = 0
join.ClipsDescendants = true
join.Size = UDim2.new(0, 360, 0, 260)
join.Visible = false
join.ZIndex = 10
...
Toggle_2.Position = UDim2.new(0, 76, 0, 228)
Toggle_2.Size = UDim2.new(0, 70, 0, 24)
Toggle_2.Text = "Disabled"
styleButton(Toggle_2)
...
Clear_2.Name = "Clear"
Clear_2.Parent = join
Clear_2.Position = UDim2.new(0, 10, 0, 228)
Clear_2.Size = UDim2.new(0, 60, 0, 24)
Clear_2.Text = "Clear"
styleButton(Clear_2)
...
scroll_3.BackgroundColor3 = Theme.Bg1
scroll_3.BorderSizePixel = 0
scroll_3.Position = UDim2.new(0, 10, 0, 34)
scroll_3.Size = UDim2.new(0, 340, 0, 186)
scroll_3.ZIndex = 10
...
scroll_3.ScrollBarImageColorId = Theme.Accent2
scroll_3.ScrollBarImageColor3 = Theme.Accent2
...
selectChat.Position = UDim2.new(0, 10, 0, 4)
selectChat.Size = UDim2.new(0, 170, 0, 26)
selectChat.Text = "Chat Logs"
styleButton(selectChat, true)
...
selectJoin.Position = UDim2.new(0, 180, 0, 4)
selectJoin.Size = UDim2.new(0, 170, 0, 26)
selectJoin.Text = "Join Logs"
styleButton(selectJoin)
table.insert(shade3, selectJoin)
table.insert(text1, selectJoin)

--╔══════════════════════════════════════════════════════════╗
--║  Применяем тему ко всем элементам (единый стиль)        ║
--╚══════════════════════════════════════════════════════════╝
task.defer(function()
    -- скругления для всех панелей
    for _, obj in ipairs({Notification, Tooltip, Settings, KeybindsFrame, PositionsFrame,
                           AliasesFrame, PluginsFrame, background_2, background_3,
                           background_4, chat, join, shadow, shadow_2, shadow_3, shadow_4}) do
...
--==============================================================
--  END MODERN UI
--  ⚠️  Дальше в оригинальном скрипте должен идти код,
--     начиная с комментария "-- xylex & europa" и далее —
--     блок iyassets, getcustomasset, writefile/readfile, и т.д.
--     (то есть с того места, где в оригинале начинается
--     currentVersion = "6.4.2" и до конца файла без изменений).
--==============================================================
...
function CreateJoinLabel(player, userId)
    ...
    info1.Text = "Username: " .. player.Name .. "\nJoined Server: " .. Time()
...
if not isLegacyChat then
	TextChatService.MessageReceived:Connect(function(textChatMessage)
		if textChatMessage.TextSource and textChatMessage.Status ~= Enum.TextChatMessageStatus.InvalidTextChannelPermissions then
            ...
            pcall(function() if textChatMessage.WasRewritten == true then message = "(rephrased) " .. textChatMessage.RewrittenText end end)
            pcall(function() if type(textChatMessage.OriginalText) == "string" then message = textChatMessage.OriginalText end end)
